...
![plugin installation command](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/command.png)
...
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/gatsby-config.png)
...
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/import.png)

Puis l'on crée un component Newsletter que l'on va exporter:

![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code1.png)
...
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code2.png)
...
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code5.png)

Qui sera appellé dans une nouvelle fonction ``` changeEmailHandler()``` :

![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code6.png)
On crée également un second hook qui va simplement permettre d'actualiser le message, qui est vide au début :

![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code8.png)

Et une fonction ``` validate()``` qui appellera notre hook :

![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code9.png)
...
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code7.png)
...
On appelle la fonction ``` handleSubmit()``` dans l'attribut "onSubmit" de notre formulaire :
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code10.png)

Et la fonction ``` changeEmailHandler()``` dans l'attribut "onChange" de notre input :
![gatsby-config.js](/media/2021-30-06---Ajouter-une-newsletter-facilement-avec-Mailchimp/code11.png)
